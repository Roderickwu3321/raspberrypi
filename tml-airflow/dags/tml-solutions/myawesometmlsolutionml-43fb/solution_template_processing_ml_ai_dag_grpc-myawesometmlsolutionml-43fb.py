...
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-43fb.tml_read_gRPC_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-43fb")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_grpc_dag-myawesometmlsolutionml-43fb",

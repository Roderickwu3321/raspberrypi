...
default_args = {
 ...
 'solutionname': 'myawesometmlsolution-43fb',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlsolution-43fb", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlsolution-43fb"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass

...
default_args = {
  ...
  'mqtt_broker' : 'bd63c6b164fe4e95a07c8309145adbd9.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-SuperRod-43fb", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-SuperRod-43fb"], schedule=None,catchup=False)
